...
class SessionEvent(Base):
    ...
    Columns:
        ...
        is_streaming:     True when the upstream responded with SSE / text/event-stream.
        duration_ms:      Round-trip time in milliseconds (NULL for in-flight streams).
    ...
    is_streaming: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)
