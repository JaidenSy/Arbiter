...
The counterargument for DIY: you own the code, you understand every decision, there is no dependency on an external project. That is a legitimate concern. Arbiter is MIT licensed and self-hostable — you can fork it, audit it, and never depend on the hosted version.
