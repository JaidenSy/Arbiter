...
Teams that try to solve this split tools across separate MCP servers — one server for read, one for write. This is operationally painful and doesn't scale.
