...
Arbiter sits between your AI agents and your MCP servers. Every tool call passes through it. In exchange for that position, it gives you agent identity, encrypted secrets, per-tool access control, a semantic cache, and a gapless audit log.
